...
const Overlay: React.FC = () => {
  ...
  return (
    <>
      <div
        className="fixed inset-0 w-screen h-screen bg-black/40 overflow-visible"
        style={{ cursor: "none" }}
      ...
      >
        ...
        <button
          ...
          style={{ cursor: "none" }}
          className="fixed top-5 right-5 bg-red-500 hover:bg-red-600 hover:bg-opacity-95 text-white border-none px-4 py-2 font-sans text-sm z-[5000] transition-colors duration-200"
        >
          Cancel (ESC)
        </button>
        ...
        <div
          ref={selectionRef}
          className="absolute border-2 border-primary-foreground bg-primary/10 pointer-events-none"
          style={{
        ...
        <div
          ref={selectionRef}
          className="absolute border-[0.5px] border-black bg-primary/5 pointer-events-none"
          style={{
            left: selectionStyle.left,
            top: selectionStyle.top,
            width: selectionStyle.width,
