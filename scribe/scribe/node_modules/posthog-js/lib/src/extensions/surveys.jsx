...
var SurveyManager = /** @class */ (function () {
    ...
    SurveyManager.prototype._handleUrlPrefill = function (survey) {
        ...
        try {
            var _b = (0, survey_url_prefill_1.extractPrefillParamsFromUrl)(window.location.search), params = _b.params, autoSubmit = _b.autoSubmit;
            ...
            var shouldAutoSubmit = autoSubmit &&
                ((_a = this._posthog.config.surveys) === null || _a === void 0 ? void 0 : _a.autoSubmitIfComplete) &&
                (0, survey_url_prefill_1.allRequiredQuestionsFilled)(survey, responses);
            if (shouldAutoSubmit) {
    ...
    SurveyManager.prototype._scheduleAutoSubmit = function (survey, responses, submissionId) {
        var _this = this;
        var _a, _b;
        var delay = (_b = (_a = this._posthog.config.surveys) === null || _a === void 0 ? void 0 : _a.autoSubmitDelay) !== null && _b !== void 0 ? _b : 800;
        survey_utils_1.SURVEY_LOGGER.info('[Survey Prefill] Auto-submit scheduled');
        this._autoSubmitTimeout = setTimeout(function () {
            survey_utils_1.SURVEY_LOGGER.info('[Survey Prefill] Auto-submitting survey');
    ...
    SurveyManager.prototype._clearAutoSubmitTimeout = function () {
