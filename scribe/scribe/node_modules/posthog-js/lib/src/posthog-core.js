...
var posthog_featureflags_stub_1 = require("./posthog-featureflags-stub");
var instances = {};
...
var PostHog = /** @class */ (function () {
    ...
    Object.defineProperty(PostHog.prototype, "featureFlags", {
        get: function () {
            var _a;
            return (_a = this._featureFlags) !== null && _a !== void 0 ? _a : posthog_featureflags_stub_1.FEATURE_FLAGS_STUB;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(PostHog.prototype, "decideEndpointWasHit", {
        ...
        get: function () {
            var _a, _b;
            return (_b = (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.hasLoadedFlags) !== null && _b !== void 0 ? _b : false;
        },
        enumerable: false,
        configurable: true
    });
    ...
    PostHog.prototype._initExtensions = function (startInCookielessMode) {
        ...
        if (ext.featureFlags) {
            this._extensions.push((this._featureFlags = (_a = this._featureFlags) !== null && _a !== void 0 ? _a : new ext.featureFlags(this)));
        }
        if (ext.exceptions) {
    ...
    PostHog.prototype.getFeatureFlag = function (key, options) {
        var _a;
        return (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.getFeatureFlag(key, options);
    };
    /**
    ...
    PostHog.prototype.getFeatureFlagPayload = function (key) {
        var _a;
        return (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.getFeatureFlagPayload(key);
    };
    /**
    ...
    PostHog.prototype.getFeatureFlagResult = function (key, options) {
        var _a;
        return (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.getFeatureFlagResult(key, options);
    };
    /**
    ...
    PostHog.prototype.isFeatureEnabled = function (key, options) {
        var _a;
        return (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.isFeatureEnabled(key, options);
    };
    /**
    ...
    PostHog.prototype.reloadFeatureFlags = function () {
        var _a;
        (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.reloadFeatureFlags();
    };
    /**
    ...
    PostHog.prototype.updateFlags = function (flags, payloads, options) {
        var _a;
        (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.updateFlags(flags, payloads, options);
    };
    /**
    ...
    PostHog.prototype.updateEarlyAccessFeatureEnrollment = function (key, isEnrolled, stage) {
        var _a;
        (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.updateEarlyAccessFeatureEnrollment(key, isEnrolled, stage);
    };
    /**
    ...
    PostHog.prototype.getEarlyAccessFeatures = function (callback, force_reload, stages) {
        ...
        return (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.getEarlyAccessFeatures(callback, force_reload, stages);
    };
    /**
    ...
    PostHog.prototype.identify = function (new_distinct_id, userPropertiesToSet, userPropertiesToSetOnce) {
        ...
        if (new_distinct_id !== previous_distinct_id && isKnownAnonymous) {
            ...
            (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.setAnonymousDistinctId(previous_distinct_id);
        }
    ...
    PostHog.prototype.setPersonPropertiesForFlags = function (properties, reloadFeatureFlags) {
        ...
        (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.setPersonPropertiesForFlags(properties, reloadFeatureFlags);
    };
    /**
    ...
    PostHog.prototype.resetPersonPropertiesForFlags = function () {
        var _a;
        (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.resetPersonPropertiesForFlags();
    };
    /**
    ...
    PostHog.prototype.setGroupPropertiesForFlags = function (properties, reloadFeatureFlags) {
        ...
        (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.setGroupPropertiesForFlags(properties, reloadFeatureFlags);
    };
    /**
    ...
    PostHog.prototype.resetGroupPropertiesForFlags = function (group_type) {
        var _a;
        (_a = this._featureFlags) === null || _a === void 0 ? void 0 : _a.resetGroupPropertiesForFlags(group_type);
    };
    /**
    ...
    PostHog.prototype.reset = function (reset_device_id) {
        ...
        (_e = this._featureFlags) === null || _e === void 0 ? void 0 : _e.reset();
